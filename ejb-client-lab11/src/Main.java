...
public class Main {
    ...
    @EJB(mappedName = "db.daos.interfaces.DaoInterface")
    private static DaoInterface dao;

    @EJB(mappedName = "db.daos.interfaces.FacultyDaoInterface")
    private static FacultyDaoInterface facultyDao;

    @EJB(mappedName = "db.daos.interfaces.UserDaoInterface")
     ...
     * @return Faculty
     */
    private static Faculty readFaculty(Scanner scanner, FacultyDaoInterface facultyDao) {
